...
export const WorkbenchWorkspace = ({
  ...
  const formattedTokenCount = useMemo(
    () => formattedOutput.split(",").map((part) => part.trim()).filter(Boolean).length,
    [formattedOutput],
  );
  ...
  return (
    <section className="ue-workspace ue-workspace--workbench ue-animate-in" data-tour-id="workbench-workspace">
      <div className="ue-pane-header ue-pane-header--compact ue-workbench-hero">
          ...
          {activeTool === "artist" ? (
            <div className="ue-workbench-grid ue-workbench-grid--expanded">
              <article className="ue-tool-panel ue-tool-panel--generator" data-tour-id="workbench-generator">
                <div className="ue-tool-panel-head ue-tool-panel-head--split">
                  <div>
                  ...
                  <div className="ue-workbench-mini-metrics" aria-label={t("workbenchGeneratorMetrics")}>
                    <span>
                      <strong>{artistCount}</strong>
                      {t("artistCount")}
                    </span>
                    <span>
                      <strong>{resultTokenCount}</strong>
                      {t("workbenchResultTokens")}
                    </span>
                  </div>
                </div>
                ...
                <div className="ue-tool-form">
                  <div className="ue-tool-subsection">
                    <span>01</span>
                    <strong>{t("workbenchRecipeSection")}</strong>
                  </div>
                  ...
                  <div className="ue-tool-subsection">
                    <span>02</span>
                    <strong>{t("workbenchOutputSection")}</strong>
                  </div>
                  ...
                  <div className="ue-tool-subsection">
                    <span>03</span>
                    <strong>{t("workbenchFormatSection")}</strong>
                  </div>
                  <div className="ue-tool-grid ue-tool-grid--wide">
                    <label>
                  ...
                  {formattedOutput ? (
                    <div className="ue-workbench-result-meta">
                      <Sparkles size={13} />
              ...
              <div className="ue-workbench-stack">
                <article className="ue-tool-panel ue-tool-panel--summary ue-workbench-queue-card">
                  <div className="ue-tool-panel-head ue-tool-panel-head--split">
                    <div>
                      <div className="ue-section-kicker">
                        <Sparkles size={14} />
                    ...
                    <span className="ue-workbench-count-pill">{preselectedNames.length}</span>
                  </div>
                ...
                <article className="ue-tool-panel ue-tool-panel--source">
                  <div className="ue-tool-panel-head ue-tool-panel-head--split">
                    ...
                    <span className="ue-workbench-count-pill">{previewTotal}</span>
                  </div>
