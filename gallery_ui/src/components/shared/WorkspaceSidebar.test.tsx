...
import { buildFolderTree, getFolderDateSortValue } from "./folderTree";
...
describe("WorkspaceSidebar folder tree", () => {
  ...
  it("keeps generated date folders in date order even when directory mtimes drift", () => {
    const tree = buildFolderTree(
      [
        "default_output::Anima 2026-06-07",
        "default_output::Anima 2026-05-27",
        "default_output::Anima 2026-05-28",
        "default_output::Anima 2026-06-06",
      ],
      new Set(),
      "modified",
      sources,
      ...
      "default_output",
      new Map([
        ["default_output::Anima 2026-06-07", 400],
        ["default_output::Anima 2026-05-27", 900],
        ["default_output::Anima 2026-05-28", 100],
        ["default_output::Anima 2026-06-06", 300],
      ]),
    );
  ...
  it("ignores impossible date-like folder names for date sorting", () => {
    expect(getFolderDateSortValue("default_output::Anima 2026-02-31")).toBe(0);
    expect(getFolderDateSortValue("default_output::Anima 2026-02-28")).toBe(20260228);
  });
